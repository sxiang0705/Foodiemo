...
const FOODIEMO_BUILD = Object.freeze({version: "v2.1.9", updatedAt: "2026-09-20T16:23:56+08:00"});
...
window.signalFoodiemoFeatureReady = function() {
    ...
    requestAnimationFrame(() => requestAnimationFrame(() => window.top.postMessage({type:'featureReady', url:window.location.href}, '*')));
};
